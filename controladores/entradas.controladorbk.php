	...
	static public function ctrCrearEntrada(){
		...
		if(isset($_POST["nPlaca"])){
			...
			if($respuesta == "ok"){
				...
				$reporteEntrada = new ReporteEntradaVehiculo();
  				$reporteEntrada -> reporteVe($idReporte);
...
class PDF extends FPDF{
  ...
  =============================================*/     
  class ReporteEntradaVehiculo{
   
	public function reporteVe($idReporte){
	...
	} // fin funcion reporteEntrada
	
  }// fin class ReportesEntrada

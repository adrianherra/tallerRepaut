<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Dima Ordenes</li>
    </ol>
  ...
  <section class="content">
    ...
    <div class="box">                
      ...
      <div class="box-header with-border">
         ...
         <form id = "pasar" action="lineas" method="post">
         ...
         <table class="table table-bordered table-striped table-condensed dt-responsive tablaOrdenes" width="100%">
              <thead class="bg-primary text-light">
                 <tr> 
                    ...
                    <th style="font-size: x-small;"><span class="text-primary">___</span>Monto<span class="text-primary">___</span></th>
                    <th style="font-size: x-small;"><span class="text-primary">___</span>Costo<span class="text-primary">___</span></th>
                    <th style="font-size: x-small;"><span class="text-primary">__</span>Utilidad<span class="text-primary">__</span></th>
                    <th style="font-size: x-small;">%_Utl</th>
                    <th style="font-size: x-small;"><span class="text-primary">___</span>Saldo<span class="text-primary">___</span></th>
              ...
              <tbody>
                  ...
                  <?php    
                      ...
                      foreach ($ordenes as $key => $value) {
                        ...
                        $orden = "<button class='btn btn-warning btnVerDetalle btn-xs' vIdOrden = '".$value["id"]."'  >".$value["orden"]."</button>";
                          
                        $venta = $value["montoOrden"];
                        $costo = $value["costoOrden"] + $value["envio"] + $value["flete"] + $value["impAduanas"] ;
                        ...
                        if ($tipo == "Anulado")
                          $estado = "<button class='btn btn-success btn-xs' >".$tipo."</button>";
                        if ($tipo == "En Proceso")
           ...
           <div class="box-body">
             ...
             <!--========================================================================== --> 
                      ...
                      <div class="form-group">
                         <div class="input-group">
                             ...
                             <select class= "form-control input-xs" name="nuevaAseguradora" id="nuevaAseguradora" >
                                 <?php
                                    //$aseguradoras = ModeloOrdenes::getAseguradoras();
                                    //$aseguradoras = ModeloOrdenes::mdlMostrarAseguradoras();
                                    $aseguradoras = ControladorAseguradoras::ctrMostrarAseguradoras(null, null);
                                    foreach($aseguradoras as $dato){
              ...
              <div class="row"> <!-- TERCERA LINEA DE ENTRADA -->
                 ...
                 <div class="col-xs-12 col-sm-6"> 
                      ...
                      <div class="form-group">
                          <div class="input-group">
                             <span class="input-group-addon"><i class="fa fa-file"></i></span> 
                             <input type="text" class="form-control input-xs" id="nuevaObserva" name="nuevaObserva"  placeholder="Observaciónes" onfocus=" obtieneFoco('#nuevaObserva')" onblur = "pierdeFoco('#nuevaObserva')" onkeypress="siguiente(event,'#nuevoEnvio')" >
                          </div>
                      </div>    
                  </div><!--fin  item 3-->
              ...
              <div class="row"> <!-- CUARTA LINEA DE ENTRADA -->       
                  <div class="col-xs-12 col-sm-3"> 
                      <!-- ENTRADA PARA EL ENCOMIENDA-->
                      <div class="form-group">
                          <div class="input-group">
                             <span class="input-group-addon"><i class="fa fa-truck"></i></span> 
                             <input type="number" class="form-control input-xs" id="nuevoEnvio" name="nuevoEnvio"  placeholder="Encomienda" onfocus=" obtieneFoco('#nuevoEnvio')" onblur = "pierdeFoco('#nuevoEnvio')" onkeypress="siguiente(event,'#nuevoFlete')" >
                          </div>
                      </div> 
                  </div><!--fin  item 1-->
                  <div class="col-xs-12 col-sm-3"> 
                      <!-- ENTRADA PARA EL FLETE-->
                      <div class="form-group">
                          <div class="input-group">
                             <span class="input-group-addon"><i class="fa fa-plane"></i></span> 
                             <input type="number" class="form-control input-xs" id="nuevoFlete" name="nuevoFlete"  placeholder="Flete Mia" onfocus=" obtieneFoco('#nuevoFlete')" onblur = "pierdeFoco('#nuevoFlete')" onkeypress="siguiente(event,'#nuevoImpAduanas')" >
                          </div>
                      </div> 
                  </div><!--fin  item 2-->
                  <div class="col-xs-12 col-sm-3"> 
                      <!-- ENTRADA PARA EL IMPUESTO ADUANAS-->
                      <div class="form-group">
                          <div class="input-group">
                             <span class="input-group-addon"><i class="fa fa-dollar"></i></span> 
                             <input type="number" class="form-control input-xs" id="nuevoImpAduanas" name="nuevoImpAduanas"  placeholder="Imp. Aduanas" onfocus=" obtieneFoco('#nuevoImpAduanas')" onblur = "pierdeFoco('#nuevoImpAduanas')" >
                          </div>
                      </div> 
                  </div><!--fin  item 3-->   
              ...
              <div class="row"> <!-- CUARTA LINEA DE ENTRADA -->       
                  <div class="col-xs-12 col-sm-3"> 
                      ...
                      <div class="form-group">
                          <div class="input-group">
                             <span class="input-group-addon"><i class="fa fa-truck"></i></span> 
                             <input type="number" class="form-control input-xs" id="editaEnvio" name="editaEnvio"  placeholder="Encomienda" onfocus=" obtieneFoco('#editaEnvio')" onblur = "pierdeFoco('#editaEnvio')" onkeypress="siguiente(event,'#editaFlete')" >
                          </div>
                      </div> 
                  </div><!--fin  item 1-->
                  <div class="col-xs-12 col-sm-3"> 
                      ...
                      <div class="form-group">
                          <div class="input-group">
                             <span class="input-group-addon"><i class="fa fa-plane"></i></span> 
                             <input type="number" class="form-control input-xs" id="editaFlete" name="editaFlete"  placeholder="Flete Mia" onfocus=" obtieneFoco('#editaFlete')" onblur = "pierdeFoco('#editaFlete')" onkeypress="siguiente(event,'#editaImpAduanas')" >
                          </div>
                      </div> 
                  </div><!--fin  item 2-->
                  <div class="col-xs-12 col-sm-3"> 
                      ...
                      <div class="form-group">
                          <div class="input-group">
                             <span class="input-group-addon"><i class="fa fa-dollar"></i></span> 
                             <input type="number" class="form-control input-xs" id="editaImpAduanas" name="editaImpAduanas"  placeholder="Imp. Aduanas" onfocus=" obtieneFoco('#editaImpAduanas')" onblur = "pierdeFoco('#editaImpAduanas')" >
                          </div>
                      </div> 
                  </div><!--fin  item 3-->   
              </div> <!-- FIN CUARTA LINEA -->        
...
<div id="modalReportesOrden" class="modal fade" role="dialog">
  <div class="modal-dialog" style="width: 70% !important;">
    <div class="modal-content">
      <form method="post" action="reportes/reporteOrdenes.php">  
        <!-- Cabeza del Modal -->
        <div class="modal-header" style="background:#3c8dbc; color:white"> 
            <button type="button" class="close" data-dismiss="modal">&times;</button>
                ...
                <div class="form-group saldos" >  
                   <div class="input-group">
                     ...
                     <select class= "form-control input-xs" name="sTipo" id="sTipo" style="width:150px; background-color: cyan">
                        <option value="resumido" selected = "selected">Resumido</option>

...
<?php  
  ...
  $caso = ControladorEntradas::ctrMostrarEntradas($item, $valor);
    ...
    <div class="box">
      ...
      <div class="box-body">
        <div class="row"> 
                    ...
                    $extencion = explode(".",$value["ruta"]);
                      ...
                      echo '<li>
                           ...
                           echo '<div class="information__image">
                                   <p class="titulo__image" style="font-size:7px;">'.$value["titulo"].'</p>
          ...
          <div class="col-xs-12 col-lg-5 ver__image">
          ...
          <div class="box-body">
            ...
            <div class="row"> <!-- Incio Row -->
              ...
              <div class="col-xs-12 col-sm-4">
                <div class="divFile">
                  <span class="texto">
                    <i class="fa fa-sign-in"> Añadir ..</i>   
                  </span>

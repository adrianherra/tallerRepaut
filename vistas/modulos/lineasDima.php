...
<div class="content-wrapper">
  <section class="content-header">
     <h1>Detalle de la Orden Dima OLD</h1>
     <ol class="breadcrumb">     
        <li><a href="inicio"><i class="fa fa-dashboard"></i> Inicio</a></li>
        <li class="active">Lineas de Compra Dima OLD</li>
     </ol>
  </section>   
    ...
    <div class="box">
      ...
      <div class="box-body">
          <?php
              ...
              $orden = ControladorOrdenesDima::ctrMostrarOrdenes($item, $valor);
                                ...
                                foreach ($lineas as $key => $value) {
                                  ...
                                  //if($_SESSION["perfil"] == "Administrador"){
                                    if ($valorEstado == "En Proceso") { 
                                       $estado = "<select class= 'input-xs btnVerEstadoOld btn-primary' name='nEstado' id='nEstado' nLinea= '".$valorId."'><option value='En Proceso' selected>En Proceso</option><option value='Entregado'>Entregado</option><option value='Pagado'>Pagado</option></select>";
                                    }// fin if  
                                    if ($valorEstado == "Entregado") {
                                       $estado = "<select class= 'input-xs btnVerEstadoOld btn-warning' name='nEstado' id='nEstado' nLinea= '".$valorId."'><option value='En Proceso'>En Proceso</option><option value='Entregado' selected>Entregado</option><option value='Pagado'>Pagado</option></select>";$entregado ++;   
                                    } // fin if   
                                    if ($valorEstado == "Pagado") { 
                                       $estado = "<select class='input-xs btnVerEstadoOld btn-info' name='nEstado' id='nEstado' nLinea= '".$valorId."'><option value='En Proceso'>En Proceso</option><option value='Entregado'>Entregado</option><option value='Pagado' selected>Pagado</option></select>";$pagado ++;  
                                    } else {
                                  ...
                                  echo '<tr>
                                            ...
                                            <td>
                                              <div class="btn-group">';
                                              if($_SESSION["perfil"] == "Administrador"){    
                                                echo'  <button class="btn btn-warning btn-xs btnEditarLineaOld" idLinea="'.$value["id"].'" data-toggle="modal" data-target="#modalEditarLinea"><i class="fa fa-pencil"></i></button> 
                                                  <button class="btn btn-danger btn-xs btnEliminarLineaOld" idLinea="'.$value["id"].'" idOrden="'.$value["idOrden"].'" montoOrden= "'.$venta.'" costoOrden = "'.$costo.'" estado= "'.$estado.'" ><i class="fa fa-times"></i></button>';      
                                              }else {      
      ...
      <div class="box-footer">
           ...
           <button type="button" class="btn btn-warning btnRegresarOld" nValor= "<?php echo $estado; ?>" nId= "<?php echo $idOrden; ?>" nSaldo= "<?php echo $saldo; ?>" nMontoOld= "<?php echo $montoGen; ?>" nCostoOld= "<?php echo $costoGen; ?>" >
      ...
      <form role="form" method="post" enctype="multipart/form-data" onKeypress="if(event.keyCode == 13) event.returnValue = false;">
        ...
        <div class="modal-body">
           ...
           <div class="box-body">
              ...
              <br>
              <!--========================================================================== --> 
              <div class="row cExterior" style="display: none"> <!-- OCTAVA LINEA DE ENTRADA -->
                  <div class="col-xs-12 col-sm-3"> 
                      <!-- PRECIO DE VENTA -->
                      <div class="form-group">
                          <div class="input-group">
        ...
        <?php     
          $crearLinea = new ControladorLineasDima();
  ...
  <div class="modal-dialog" style="width: 80% !important;">
    ...
    <div class="modal-content">
      ...
      <form role="form" method="post" enctype="multipart/form-data" onKeypress="if(event.keyCode == 13) event.returnValue = false;">
              ...
              <div class="row cExterior" style="display: none"> <!-- SETIMA LINEA DE ENTRADA -->
                  ...
                  <div class="col-xs-12 col-sm-3"> 
                      ...
                      <div class="form-group">
                          <div class="input-group">
                             <span class="input-group-addon"><i class="fa fa-money"> Imp</i></span> 
                             <input type="text" class="form-control input-xs" id="eImpImporta" name="eImpImporta" placeholder="$ Import" onfocus=" obtieneFoco('#eImpImporta')" onblur = "pierdeFoco('#eImpImporta')" onkeypress="siguiente(event,'#eEnvio')">
                          </div>
                      </div>
                  </div><!--fin  item 4-->  
              </div> <!-- FIN SETIMA LINEA -->    
              ...
              <div class="row cExterior" style="display: none"> <!-- OCTAVA LINEA DE ENTRADA -->
                  <div class="col-xs-12 col-sm-3"> 
                      ...
                      <div class="form-group">
                          <div class="input-group">
                             <span class="input-group-addon"><i class="fa fa-money"> Envio</i></span> 
                             <input type="text" class="form-control input-xs" id="eEnvio" name="eEnvio" placeholder="$ Envio" onfocus=" obtieneFoco('#eEnvio')" onblur = "pierdeFoco('#eEnvio')" onkeypress="siguiente(event,'#eAduana')">
                          </div>
                      </div>
                  </div><!--fin  item 1-->  
                  <div class="col-xs-12 col-sm-3"> 
                      ...
                      <div class="form-group">
                          <div class="input-group">
                             <span class="input-group-addon"><i class="fa fa-money"> Aduana</i></span> 
                             <input type="text" class="form-control input-xs" id="eAduana" name="eAduana" placeholder="$ Aduana" onfocus=" obtieneFoco('#eAduana')" onblur = "pierdeFoco('#eAduana')" onkeypress="siguiente(event,'#eCostoUsa')">
                          </div>
                      </div>
                  </div><!--fin  item 2-->
                  <div class="col-xs-12 col-sm-3"> 
        ...
        <?php  
           $editarLinea = new ControladorLineasDima();

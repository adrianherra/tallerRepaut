...
$(".tablaFacturas").on("click", ".btnEditarFactura", function(){
   ...
   $.ajax({
         ...
         success: function(respuesta){
           console.log("respuesta:", respuesta);   
           $("#eIdFactura").val(respuesta[0]["idLinea"]);
...
$(".tablaFacturas").on("click", ".btnAddLinea", function(){
   $("#nCanti").focus();  
   $('.bt-factura').css('display','block');
}); // fin btnAddLinea

/*=============================================
CAMBIO DE CONDICION 
=============================================*/
$(".btnCondicion").change(function(){
   var idFactura = $("#nFactura").val();
   var condicion = $("#nCondicion").val();
   var datos = new FormData();
  	datos.append("idFactura", idFactura);
...
$(".encabezado").change(function(){
   ...
   var idFactura  = $("#nFactura").val();
   var condicion  = $("#nCondicion").val();
   var sold1      = $("#nSold1").val();
   var sold2      = $("#nSold2").val();
   var sold3      = $("#nSold3").val();
   var sold4      = $("#nSold4").val();
   var ship       = $("#nShip").val();
   var ship1      = $("#nShip1").val();
   var tracking   = $("#nTrack").val();

   var datos = new FormData();
  	datos.append("idFactura", idFactura);
   datos.append("condicion", condicion); 
   datos.append("sold1",     sold1);
   datos.append("sold2",     sold2);
   datos.append("sold3",     sold3);
   datos.append("sold4",     sold4);
   datos.append("ship",      ship);
   datos.append("ship1",     ship1);
   datos.append("tracking",  tracking);
  	$.ajax({
	  url:"ajax/facturas.ajax.php",
	  method: "POST",
	  data: datos,
